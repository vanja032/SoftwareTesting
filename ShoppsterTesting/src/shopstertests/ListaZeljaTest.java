...
public class ListaZeljaTest {
	  ...
	  private Logger logs = Logger.getLogger(ListaZeljaTest.class.getName());
	  @Before
	  public void setUp() {
	  ...
	  public void listazelja() {
		    ...
		    driver.findElement(By.xpath("//*[@id=\"cx-page-section\"]/div/div/ung-product-pagination/div/div[1]/div[1]/ung-product-grid-item/div/div[3]/ung-add-to-wishlist")).click();
		    driver.findElement(By.xpath("//*[@id=\"cx-page-section\"]/div/div/ung-product-pagination/div/div[1]/div[2]/ung-product-grid-item/div/div[3]/ung-add-to-wishlist")).click();
		    driver.findElement(By.xpath("//*[@id=\"cx-page-section\"]/div/div/ung-product-pagination/div/div[1]/div[3]/ung-product-grid-item/div/div[3]/ung-add-to-wishlist")).click();
		    driver.findElement(By.xpath("//*[@id=\"cx-page-section\"]/div/div/ung-product-pagination/div/div[1]/div[4]/ung-product-grid-item/div/div[3]/ung-add-to-wishlist")).click();
		    driver.findElement(By.xpath("//*[@id=\"cx-page-section\"]/div/div/ung-product-pagination/div/div[1]/div[5]/ung-product-grid-item/div/div[3]/ung-add-to-wishlist")).click();
		    driver.findElement(By.xpath("/html/body/ung-root/ung-storefront/header/cx-page-layout/cx-page-slot[4]/ung-mini-wishlist")).click();
		    
		    String poruka ="\nNaziv testa: ListaZeljaTest\n"+
			"Opis testa: Testiranje uspesnog dodavanja proizvoda u listu zelja\n"+
