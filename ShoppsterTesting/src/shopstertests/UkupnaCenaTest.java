...
public class UkupnaCenaTest {
	  ...
	  private Logger logs = Logger.getLogger(UkupnaCenaTest.class.getName());
	  @Before
	  public void setUp() {
	  ...
	  public void korpa() {
	      ...
	      //Third element
		    ...
		    try {
	      	...
	      	int cena1 = Integer.parseInt(driver.findElement(By.xpath("/html/body/ung-root/ung-storefront/main/cx-page-layout/cx-page-slot[2]/ung-cart-details/div/div[3]/ung-cart-item-list/div/div/div[1]/ung-cart-item/div/div[3]/div/div[2]/div[1]/div/ung-price/div/div[2]/ung-price-value/div/span[1]")).getText().replace(".", ""));
	      	int cena2 = Integer.parseInt(driver.findElement(By.xpath("/html/body/ung-root/ung-storefront/main/cx-page-layout/cx-page-slot[2]/ung-cart-details/div/div[3]/ung-cart-item-list/div/div/div[2]/ung-cart-item/div/div[3]/div/div[2]/div[1]/div/ung-price/div/div[2]/ung-price-value/div/span[1]")).getText().replace(".", ""));
	      	int cena3 = Integer.parseInt(driver.findElement(By.xpath("/html/body/ung-root/ung-storefront/main/cx-page-layout/cx-page-slot[2]/ung-cart-details/div/div[3]/ung-cart-item-list/div/div/div[3]/ung-cart-item/div/div[3]/div/div[2]/div[1]/div/ung-price/div/div[1]/ung-price-value/div/span[1]")).getText().replace(".", ""));
	      	int ukupna_i_cena = cena1 + cena2 + cena3;
	      	String ukupna_cena = driver.findElement(By.xpath("/html/body/ung-root/ung-storefront/main/cx-page-layout/cx-page-slot[3]/ung-cart-totals/div[1]/div[1]/ung-order-summary/div[2]/span[2]")).getText().replace(".", "");
	      	assertEquals(ukupna_i_cena + " RSD", ukupna_cena);
	      	
	      	String poruka ="\nNaziv testa: UkupnaCenaTest\n"+
			"Opis testa: Testiranje tacnosti podataka za ukupnu cenu dodatih proizvoda u korpu\n"+
